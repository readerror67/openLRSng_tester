...
uint8_t rfmGetRSSI1(void)
{
  return spiReadRegister(0x28);
}

uint8_t rfmGetRSSI2(void)
{
...
void rssiTest(void)
{
  ...
  while (!Serial.available()) {
    ant1 = rfmGetRSSI1();
    ant2 = rfmGetRSSI2();
    if (ant1 > ant1_max) ant1_max = ant1;
    if (ant2 > ant2_max) ant2_max = ant2;
    
    Serial.print("[");
    Serial.print(ant1_max);
    Serial.print("]  ");
    Serial.print(ant1);

    Serial.print(" -- [");
    Serial.print(ant2_max);
    Serial.print("]  ");
    Serial.println(ant2);
    delay(100);
  }
